...
public class JWebSocketClientHandler extends SimpleChannelUpstreamHandler {
    ...
    public void messageReceived(ChannelHandlerContext ctx, MessageEvent e) throws Exception {
       ...
       if (messageObj instanceof HttpResponse) {
           handleHttpResponse((HttpResponse)messageObj, e);
       } else {
       }
    }

    /**
     * Handle the HTTP response from the server, basically handshake response
     * @param response the HTTP response
     * @param e message event 
     */
    private void handleHttpResponse(HttpResponse response, MessageEvent e) {
        if (!readingChunks) {
