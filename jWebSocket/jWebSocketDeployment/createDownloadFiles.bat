...
7z u -mx9 -tzip "%dest%" "%src%jWebSocketCommon" -xr!target -xr!.svn -xr!dist -xr!build
7z u -mx9 -tzip "%dest%" "%src%jWebSocketServerAPI" -xr!target -xr!.svn -xr!dist -xr!build
7z u -mx9 -tzip "%dest%" "%src%jWebSocketServer" -xr!target -xr!.svn -xr!dist -xr!build
7z u -mx9 -tzip "%dest%" "%src%jWebSocketAppServer" -xr!target -xr!.svn -xr!dist -xr!build
7z u -mx9 -tzip "%dest%" "%src%jWebSocketAppSrvDemo" -xr!target -xr!.svn -xr!dist -xr!build
7z u -mx9 -tzip "%dest%" "%src%jWebSocketSamples" -xr!target -xr!.svn -xr!dist -xr!build
7z u -mx9 -tzip "%dest%" "%src%jWebSocketClientAPI" -xr!target -xr!.svn -xr!dist -xr!build
7z u -mx9 -tzip "%dest%" "%src%jWebSocketJavaSEClient" -xr!target -xr!.svn -xr!dist -xr!build
7z u -mx9 -tzip "%dest%" "%src%jWebSocketJetty" -xr!target -xr!.svn -xr!dist -xr!build
7z u -mx9 -tzip "%dest%" "%src%jWebSocketSwingGUI" -xr!target -xr!.svn -xr!dist -xr!build
7z u -mx9 -tzip "%dest%" "%src%jWebSocketClient" -xr!target -xr!devguide -xr!quickguide -xr!javadocs -xr!.svn -xr!dist -xr!build
7z u -mx9 -tzip "%dest%" "%src%shared" -xr!target -xr!.svn -xr!dist -xr!build
7z u -mx9 -tzip "%dest%" "%src%libs" -xr!target -xr!.svn -xr!dist -xr!build
7z u -mx9 -tzip "%dest%" "%src%pom.xml

7z u -mx9 -tzip "%dest%" "%src%jWebSocketAndroid" -xr!target -xr!.svn

7z u -mx9 -tzip "%dest%" "%src%jWebSocketRTE" -xr!.svn -xr!jWebSocket*.jar -xr!jWebSocket*.war -xr!jWebSocket-0.9.0 -xr!jWebSocket-0.9.5 -xr!jWebSocket-0.10 -xr!*.exe -xr!*.log
7z u -mx9 -tzip "%dest%" "%src%jWebSocketDeployment" -xr!.svn -xr!jWebSocket-0.7.0 -xr!jWebSocket-0.8.0 -xr!jWebSocket-0.8.5 -xr!jWebSocket-0.9.0 -xr!jWebSocket-0.9.5 -xr!jWebSocket-0.10 -xr!*.tmp*
...
xcopy %libs%netty-3.2.3.Final.jar %tempdir%libs\ /s /i /y
xcopy %libs%mysql-connector-java-5.1.13-bin.jar %tempdir%libs\ /s /i /y
xcopy %libs%jetty-continuation-8.0.0.M1.jar %tempdir%libs\ /s /i /y
xcopy %libs%jetty-http-8.0.0.M1.jar %tempdir%libs\ /s /i /y
xcopy %libs%jetty-io-8.0.0.M1.jar %tempdir%libs\ /s /i /y
xcopy %libs%jetty-server-8.0.0.M1.jar %tempdir%libs\ /s /i /y
xcopy %libs%jetty-util-8.0.0.M1.jar %tempdir%libs\ /s /i /y
xcopy %libs%jetty-websocket-8.0.0.M1.jar %tempdir%libs\ /s /i /y
xcopy %libs%servlet-api-2.5-6.1.14.jar %tempdir%libs\ /s /i /y
xcopy %libs%json-2-RELEASE65.jar %tempdir%libs\ /s /i /y
xcopy %libs%ehcache-core-2.3.0.jar %tempdir%libs\ /s /i /y
xcopy %libs%slf4j-api-1.5.2.jar %tempdir%libs\ /s /i /y
xcopy %libs%slf4j-log4j12-1.5.2.jar %tempdir%libs\ /s /i /y
xcopy %libs%smack-3.1.0.jar %tempdir%libs\ /s /i /y
xcopy %libs%smackx-3.1.0.jar %tempdir%libs\ /s /i /y
xcopy %libs%twitter4j-core-2.1.8.jar %tempdir%libs\ /s /i /y
...
7z u -mx9 -r -tzip "%dest%" "%down%jWebSocketFullSources-%JWEBSOCKET_VER%.zip"
