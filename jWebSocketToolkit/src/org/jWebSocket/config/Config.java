...
public class Config {
	 ...
	 */
	public static final int MIN_IN_PORT = 1024;
	/**
	 * Maximum allow outgoing TCP Socket port.
	 */
	public static final int MAX_IN_PORT = 65535;
	/**
	 * Default Port for optional user specific WebSocket protocols.
	 */
	public static final int DEFAULT_PORT_USER = 8787;
	/**
	 * Default Port for standard token based WebSocket protocols (JSON, CSV and XML).
	 */
	public static final int DEFAULT_PORT_TOKEN = 8788;
	/**
	 ...
	 * (3600000ms = 1h).
	 */
	public final static int MAX_TIMEOUT = 3600000;
	 ...
	 */
	public static final String PATHARG_SEPARATOR = ";";

	/**
	 * separator between the various arguments.
	 */
	public static final String ARGARG_SEPARATOR = ",";
