    ...
    public static Token packetToToken(WebSocketPacket aDataPacket) {
        ...
        try {
            ...
            for (Iterator lIterator = lJO.keys(); lIterator.hasNext();) {
                ...
                // Quentin:
                // Maybe we souldn't use the JSON api but directly re-write a
                // "converter" from Json to Token...
                // User should always handle List and Map, never JSONObject or
                // JSONArray, since we don't know if xml, csv or json is used as
                // protocol.
