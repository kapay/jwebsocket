 ...
 * @author puran
 * @version $Id: JWebSocketTokenClient.java 697 2010-07-17 21:43:50Z mailtopuran@gmail.com $
 */
public interface JWebSocketTokenClient extends JWebSocketClient {
    /**
     ...
     */
    void login(String username, String password) throws WebSocketException;
    /**
     * Logout the user 
     ...
     */
    void broadcastText(String text) throws WebSocketException;
    /**
     ...
     */
    void ping(boolean echo) throws WebSocketException;
    /**
     * Send the text data 
     ...
     */
    void sendText(String target, String message) throws WebSocketException;
    /**
