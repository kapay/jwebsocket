...
//        rpcToken.setBoolean("spawnThread", Boolean.FALSE);
    ...
    public void processToken(WebSocketClientEvent aEvent, Token aToken) {
        if((CommonRpcPlugin.RPC_TYPE).equals(aToken.getString("reqType")) && ("response").equals(aToken.getType())) {
    ...
    private static Handler handler = new Handler() {
      ...
      public void handleMessage(Message msg) {
      	 Toast.makeText(mContext, msg.getData().get("method")+" has been called by the server (args "+msg.getData().get("args"), Toast.LENGTH_SHORT).show();
      }
    };
